     ...
     <div class="panel panel-default">
       <div class="panel-heading">
        <strong>
          ...
          Mettre à jour <?php echo remove_junk(ucwords($e_user['name'])); ?> Compte
        </strong>
       </div>
            ...
            <div class="form-group">
              <label for="status">Statut</label>
                <select class="form-control" name="status">
                  ...
                  <option <?php if($e_user['status'] === '0') echo 'selected="selected"';?> value="0">Désactif</option>
                </select>
            </div>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          <span class="glyphicon glyphicon-th"></span>
          Changement <?php echo remove_junk(ucwords($e_user['name'])); ?> mot de passe
        </strong>
      </div>
      <div class="panel-body">
        <form action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
          ...
          <div class="form-group clearfix">
                  <button type="submit" name="update-pass" class="btn btn-danger pull-right">Changement</button>
          </div>
        </form>
      </div>
    </div>
